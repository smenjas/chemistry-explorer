...
class Compounds {
    static data = {
        ...
        C8H8N4: ['Hydralazine'],
        C8H8O3: ['Methyl salicylate', 'Vanillin'],
        ...
        C10H20O2: ['Capric acid', 'p-Menthane-3,8-diol', 'Paramenthane hydroperoxide'],
        ...
        C20H30O3: ['Galanolactone', 'Leukotriene A4', 'Neotripterifordin', 'Steviol'],
