...
export default {
    ...
    HCN: ['Hydrogen cyanide', 'Hydrogen isocyanide'],
    HCNO: ['Cyanic acid', 'Fulminic acid', 'Isocyanic acid'],
    HN: ['Imidogen'],
    HNO: ['Nitroxyl'],
    HNO2: ['Nitrous acid'],
    ...
    CHBr3: ['Bromoform'],
    CHI3: ['Iodoform'],
    CH2N2: ['Cyanamide', 'Diazirine', 'Diazomethane', 'Isodiazomethane'],
    ...
    CH3NO: ['Formaldoxime', 'Formamide', 'Nitrosomethane', 'Oxaziridine'],
    ...
    CH3Hg: ['Methylmercury'],
    CH4: ['Methane'],
    CH4N2: ['Ammonium cyanide', 'Diaziridine', 'Formamidine'],
    CH4N2O: ['Ammonium carbamate', 'Ammonium cyanate', 'Formylhydrazine', 'Urea'],
    ...
    CH6N2: ['Methanediamine', 'Monomethylhydrazine'],
    ...
    C2H3O2NaS: ['Sodium thioglycolate'],
    C2H3O2CaS: ['Calcium thioglycolate'],
    ...
    C2H4O: ['Acetaldehyde', 'Ethylene oxide', 'Polyvinyl alcohol', 'Vinyl alcohol'],
    C2H4O2: ['Acetic acid', 'Dioxetane'],
    C2H4O2S: ['Thioglycolic acid'],
    ...
    C2H5B: ['Borirane'],
    C2H5N: ['Aziridine', 'Ethanimine', 'N-Methylmethanimine'],
    C2H5NO2: ['Glycine'],
    ...
    C2H5P: ['Phosphirane'],
    C2H6: ['Ethane'],
    C2H6NO4Al: ['Aluminum glycinate'],
    C2H6N2: ['Acetamidine', 'Azomethane'],
    C2H6N2O: ['Azoxymethane', 'Glycinamide', 'N-Nitrosodimethylamine'],
    ...
    C2H7N: ['Dimethylamine', 'Ethylamine'],
    C2H7NO2: ['Ammonium acetate'],
    C2H7NO2S: ['Ammonium thioglycolate'],
    C2H7NO3S: ['Taurine'],
    C2H7NS: ['Cysteamine'],
    ...
    C3H5ClO: ['Chloroacetone', 'Epichlorohydrin'],
    ...
    C4H2O4: ['Acetylenedicarboxylic acid', 'Squaric acid'],
    ...
    C4H9N: ['Cyclobutylamine', 'Pyrrolidine'],
    ...
    C4O2: ['Tetracarbon dioxide'],
    C4O4: ['Cyclobutanetetrone'],
    ...
    C5H2O5: ['Croconic acid'],
    C5H3LiN2O4: ['Lithium orotate'],
    C5H3CuO2S: ['Copper(I) thiophene-2-carboxylate'],
    ...
    C5H10O4: ['Deoxyribose'],
    C5H10O4S: ['Glyceryl monothioglycolate'],
    C5H10O5: ['Arabinose', 'Lyxose', 'Ribose', 'Ribulose', 'Xylose'],
    C5H10S: ['Prenylthiol', 'Thiane'],
    C5H11N: ['Piperidine'],
    C5H11NO: ['Isovaleramide'],
    C5H11NO2: ['Amyl nitrite', 'Norvaline', 'Isovaline', 'Trimethylglycine', 'Valine'],
    ...
    C6H9LaO6: ['Lanthanum acetate'],
    C6H9O6Pr: ['Praseodymium(III) acetate'],
    C6H9O6Nd: ['Neodymium acetate'],
    C6H9O6Sm: ['Samarium(III) acetate'],
    ...
    C6O12Gd2: ['Gadolinium(III) oxalate'],
    ...
    C8H5NO2: ['Indole-5,6-quinone', 'Isatin', 'Phthalimide'],
    C8H6: ['Pentalene'],
    ...
    C8H6O4: ['Benzenedicarboxylic acid', 'Isophthalic acid', 'Phthalic acid', 'Terephthalic acid'],
    C8H6O5: ['Stipitatic acid'],
    C8H6S: ['Benzothiophene'],
    C8H7N: ['Indole', 'Isoindole'],
    C8H7NO: ['Oxindole'],
    C8H7NO2: ['5,6-Dihydroxyindole'],
    C8H7NNa4O8: ['Tetrasodium iminodisuccinate'],
    C8H7NS: ['Benzothiazine', 'Benzyl isothiocyanate'],
    ...
    C8H11NO: ['4-Dimethylaminophenol', 'Tyramine'],
    ...
    C9H9N: ['Skatole'],
    C9H9NO4: ['L-Dopaquinone', 'Leucodopachrome'],
    ...
    C10H14O4Cu: ['Copper(II) acetylacetonate'],
    ...
    C12H12N2O: ['Harmalol', '4,4\'-Oxydianiline'],
    ...
    C12H17NO3: ['Bucetin', 'Cerulenin', 'Etamivan'],
    ...
    C13H14N4O4: ['NITD008'],
    C13H14O5: ['Citrinin'],
    C13H15ClN4O3Pt: ['Phenanthriplatin'],
    ...
    C14H18GdN3O10: ['Gadopentetic acid'],
    ...
    C15H10O: ['Diphenylcyclopropenone'],
    C15H10O2: ['Flavone'],
    C15H10F6O2: ['Bisphenol AF'],
    ...
    C15H14N2O6: ['Dinitrobisphenol A'],
    C15H14FN3O3: ['Flumazenil'],
    ...
    C15H20O6: ['Vomitoxin'],
    C15H20O8: ['Anisatin'],
    C15H21NO2: ['Desmethylprodine', 'Dextropropoxyphene', 'Ketobemidone', 'Pethidine'],
    C15H21NO9S2: ['Gluconasturtiin'],
    C15H21N3O: ['Primaquine'],
    C15H21N3O2: ['Physostigmine'],
    ...
    C15H21LaO6: ['Lanthanum acetylacetonate'],
    C15H21O6Ce: ['Cerium(III) acetylacetonate'],
    C15H21O6Pr: ['Praseodymium acetylacetonate'],
    C15H21GdO6: ['Gadolinium acetylacetonate'],
    ...
    C15H22O2: ['Polygodial'],
    C15H22O3: ['Gemfibrozil', 'Nardosinone', 'Octyl salicylate', 'Sterpuric acid'],
    ...
    C15H24: ['Amorpha-4,11-diene', 'Aristolochene', 'Bergamotene', 'Bisabolene', 'Cadinene', 'Caryophyllene', 'Cedrene', 'Chamigrene', 'Copaene', 'Cubebene', 'Elemene', 'Farnesene', 'Germacrene', 'Guaiene', 'Humulene', 'Isocomene', 'Longifolene', 'Selinene', 'Thujopsene', 'Valencene', 'Zingiberene'],
    ...
    C15H25N5O6: ['Lysidine'],
    C15H25NdO8: ['Neodymium acetylacetonate'],
    ...
    C16H36Cu4O4: ['Copper(I) t-butoxide'],
    C16H40Cl4N2Ni: ['Tetraethylammonium tetrachloronickelate'],
    C16H56N8Cl6Pt2: ['Wolffram\'s red salt'],
    ...
    C18H20O2: ['Bisphenol Z', 'Diethylstilbestrol', 'Equilin'],
    ...
    C19H27N3O9S2Cl2: ['Thiamphenicol glycinate acetylcysteine'],
    C19H27N5O3: ['Bunazosin'],
    ...
    C21H24N2O4: ['Mitraphylline'],
    C21H24FN3O4: ['Moxifloxacin'],
    C21H24N4O2S: ['Mirabegron'],
    C21H24O4: ['Bisphenol A diglycidyl ether'],
    ...
    C22H28N2O4: ['19-Epivoacristine', 'Isovoacristine', 'Rhynchophylline', 'Voacristine'],
    C22H28FN3O6S: ['Rosuvastatin'],
    C22H28GdN3O11: ['Gadobenic acid'],
    ...
    C23H30N2O4: ['Mitragynine', 'Pholcodine'],
    C23H30N2O5: ['7-Hydroxymitragynine', 'Mitragynine pseudoindoxyl'],
    C23H30ClN3O: ['Mepacrine'],
    C23H30GdN3O11: ['Gadoxetic acid'],
    ...
    C24H38O4: ['Diethylhexyl phthalate', 'Dioctyl terephthalate'],
    ...
    C24H54O3Pt2Si6: ['Karstedt\'s catalyst'],
    ...
    C32H48O9: ['Cerberin', 'Oleandrin'],
    C32H49N9O5: ['Elamipretide'],
    C32H53BrN2O4: ['Rocuronium bromide'],
    ...
    C33H40GdN3Na3O15P: ['Gadofosveset'],
    ...
    C42H66O14: ['Metildigoxin', 'Neokuguaglucoside'],
    ...
    C43H66O14: ['Acetyldigitoxin', 'Gymnemic acid I'],
    C43H66O15: ['Acetyldigoxin'],
    ...
    C52H68Cu2O8: ['Copper ibuprofenate'],
    C52H72GdN5O14: ['Motexafin gadolinium'],
    ...
    C54H108LaO6: ['Lanthanum stearate'],
    ...
    C2085H3223N553O672S16: ['Digoxin immune fab'],
    ...
    KCNO: ['Potassium cyanate', 'Potassium fulminate'],
    ...
    K4Pt2H8O20P8: ['Potassium diplatinum(II) tetrakispyrophosphite'],
    ...
    CuB2F8: ['Copper(II) tetrafluoroborate'],
    CuCN: ['Copper(I) cyanide'],
    CuSCN: ['Copper(I) thiocyanate'],
    CuCO3: ['Copper(II) carbonate'],
    CuC2N2S2: ['Copper(II) thiocyanate'],
    CuC2O4: ['Copper oxalate'],
    CuC2O6F6S2: ['Copper(II) triflate'],
    CuNO3: ['Copper(I) nitrate'],
    CuN2O6: ['Copper(II) nitrate'],
    CuN6: ['Copper(II) azide'],
    CuO: ['Copper(II) oxide'],
    CuO2: ['Copper peroxide'],
    CuSeO3: ['Copper(II) selenite'],
    CuSO4: ['Copper(II) sulfate'],
    CuCl2O6: ['Copper(II) chlorate'],
    ...
    Cu2SeO4: ['Copper oxide selenite'],
    Cu2Cr2O5: ['Copper(II) chromite'],
    ...
    Cu3P2O8: ['Copper(II) phosphate'],
    Cu3As2O8: ['Copper(II) arsenate'],
    ...
    LaI2: ['Lanthanum diiodide'],
    LaI3: ['Lanthanum(III) iodide'],
    La2C3O9: ['Lanthanum carbonate'],
    La2C6O12: ['Lanthanum oxalate'],
    La2O2S: ['Lanthanum oxysulfide'],
    La2O3: ['Lanthanum oxide'],
    La2Hf2O7: ['Lanthanum hafnate'],
    La3Ga5O14Si: ['Lanthanum gallium silicate'],
    ...
    PrH3O3: ['Praseodymium(III) hydroxide'],
    PrN: ['Praseodymium(III) nitride'],
    PrNO: ['Praseodymium(V) oxide nitride'],
    PrN3O9: ['Praseodymium(III) nitrate'],
    PrO2: ['Praseodymium(IV) oxide'],
    PrScO3: ['Praseodymium orthoscandate'],
    PrAsO4: ['Praseodymium arsenate'],
    PrCl2O12: ['Praseodymium(III) perchlorate'],
    PrF3: ['Praseodymium(III) fluoride'],
    PrF4: ['Praseodymium(IV) fluoride'],
    PrP: ['Praseodymium phosphide'],
    PrCl3: ['Praseodymium(III) chloride'],
    PrAs: ['Praseodymium arsenide'],
    PrBr3: ['Praseodymium(III) bromide'],
    PrSb: ['Praseodymium antimonide'],
    PrI2: ['Praseodymium diiodide'],
    PrI3: ['Praseodymium(III) iodide'],
    PrBi: ['Praseodymium bismuthide'],
    Pr2C3O9: ['Praseodymium(III) carbonate'],
    Pr2O3: ['Praseodymium(III) oxide'],
    Pr2S3O12: ['Praseodymium(III) sulfate'],
    Pr2Se3O12: ['Praseodymium(III) selenate'],
    Pr2S3: ['Praseodymium(III) sulfide'],
    Pr6O11: ['Praseodymium(III,IV) oxide'],

    NdH2: ['Neodymium(II) hydride'],
    NdH3: ['Neodymium(III) hydride'],
    ...
    NdPO4: ['Neodymium(III) phosphate'],
    NdVO4: ['Neodymium(III) vanadate'],
    NdAsO4: ['Neodymium arsenate'],
    NdTaO4: ['Neodymium tantalate'],
    NdCl2O12: ['Neodymium(III) perchlorate'],
    NdRe3O12: ['Neodymium perrhenate'],
    NdF2: ['Neodymium(II) fluoride'],
    NdF3: ['Neodymium(III) fluoride'],
    NdF4: ['Neodymium(IV) fluoride'],
    NdP: ['Neodymium phosphide'],
    ...
    SmIO: ['Samarium oxyiodide'],
    SmPO4: ['Samarium(III) phosphate'],
    SmF2: ['Samarium(II) fluoride'],
    SmF3: ['Samarium(III) fluoride'],
    SmP: ['Samarium phosphide'],
    ...
    TbCl3O12: ['Terbium(III) perchlorate'],
    ...
    Tm2S3O12: ['Thullium(III) sulfate'],
    Tm2Se3: ['Thulium selenide'],

    YbH2: ['Ytterbium hydride'],
    YbN3O9: ['Ytterbium(III) nitrate'],
    YbPO4: ['Ytterbium(III) phosphate'],
    YbCl3O12: ['Ytterbium(III) perchlorate'],
    ...
    YbS: ['Ytterbium sulfide'],
    YbCl2: ['Ytterbium(II) chloride'],
    YbCl3: ['Ytterbium(III) chloride'],
    YbGaGe: ['Ytterbium gallium germanium'],
    ...
    YbBiPt: ['Ytterbium bismuth platinum'],
    ...
    HfC: ['Hafnium carbide'],
    HfC4O12F12S4: ['Hafnium trifluoromethanesulfonate'],
    HfN4O12: ['Hafnium nitrate'],
    HfOCl2: ['Hafnium(IV) oxychloride'],
    HfO2: ['Hafnium(IV) oxide'],
    HfSiO4: ['Hafnium(IV) silicate'],
    HfS2O8: ['Hafnium(IV) sulfate'],
    ...
    ReOF5: ['Rhenium oxide pentafluoride'],
    ReOCl4: ['Rhenium oxytetrachloride'],
    ReO2: ['Rhenium(IV) oxide'],
    ReO2F3: ['Rhenium dioxide trifluoride'],
    ReO3: ['Rhenium trioxide'],
    ReO3F: ['Rhenium trioxide fluoride'],
    ReO3Cl: ['Rhenium trioxide chloride'],
    ReF4: ['Rhenium tetrafluoride'],
    ReF5: ['Rhenium pentafluoride'],
    ...
    PtSm: ['Platinum–samarium'],
    Pt2N4H12Cl4: ['Magnus\'s green salt'],

    AuH3O3: ['Gold(III) hydroxide'],
    ...
    HgClO4: ['Mercury(I) perchlorate'],
    HgWO4: ['Mercury(II) tungstate'],
    HgBr2O6: ['Mercury(II) bromate'],
    HgI2O6: ['Mercury(II) iodate'],
    HgCl2O8: ['Mercury(II) perchlorate'],
    ...
    Hg3P2O8: ['Mercury(II) phosphate'],
    Hg3As2O8: ['Mercury(II) orthoarsenate'],
